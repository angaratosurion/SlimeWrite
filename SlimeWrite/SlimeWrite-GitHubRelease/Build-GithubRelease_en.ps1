...
$projectPath = "D:\CloudFolder\NextCloud\MyPrograms\dotNet\OpenSource\SlimeWrite\SlimeWrite\SlimeWrite-GitHubRelease\SlimeWrite-GitHubRelease.csproj"
...
foreach ($target in $targets) {
    ...
    dotnet build "`"$projectPath`"" -f $target -c Release
}
